    ...
    <>
      <div className="bg-white rounded-xl shadow-md flex flex-col justify-between items-center transition-shadow duration-300 hover:shadow-2xl h-[525px] w-full max-w-sm p-4">
        ...
        <div className="flex flex-col items-center w-full px-4 pt-4 pb-2 flex-1">
          <h3 className="text-lg font-semibold mb-1 text-center min-h-[3rem] leading-snug">
            {product.title}
          </h3>
        ...
        <div className="w-full flex justify-center pb-10 h-[60px]">
          <button
            onClick={() => setShowPopup(true)}
            className="flex items-center gap-2 bg-shop_light_green text-white px-4 py-3 rounded-lg font-semibold hover:bg-green-600 transition w-full max-w-[180px]"
          >
